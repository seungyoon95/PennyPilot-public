                    ...
                    <FormField
                            ...
                            render={({ field}) => (
                                <FormItem>
                                    ...
                                    {/* <FormDescription>Transaction title</FormDescription> */}
                                </FormItem>
                            )}
                        />
                        <FormField
                                            ...
                                            <PopoverTrigger asChild>
                                                ...
                                                className="h-[100px] w-full">
                                                    {form.watch("icon")? (
                                                        ...
                                                        <p className="text-s text-muted-foreground">Click to change</p>
                                                    </div>
                                                    ): (
                                                        <div className="flex flex-col items-center gap-2">
                                                            <CircleOff className="h-[48px] w-[48px]" />
                                                            <p className="text-s text-muted-foreground">Click to select</p>
                                                        </div>
                                                    )}
