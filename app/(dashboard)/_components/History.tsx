      ...
      <Card className="col-span-12 mt-2 w-full">
        ...
        <CardContent>
            <SkeletonWrapper isLoading={historyDataQuery.isFetching}>
                ...
                {!dataAvailable && (
                    <Card className="flex h-[300px] flex-col items-center justify-center bg-background">No data for the selected period</Card>
                )}
            </SkeletonWrapper>
        </CardContent>
      </Card>
...
function CustomTooltip({active, payload, formatter}:any) {
    ...
    return (
        <div className="min-w-[300px] rounded border bg-background p-4">
            ...
            <TooltipRow formatter={formatter} label="Balance" value={income - expense} bgColor="bg-violet-500" textColor="text-violet-500" />
        </div>
    )
}
