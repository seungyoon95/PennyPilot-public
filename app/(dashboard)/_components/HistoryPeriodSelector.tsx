  ...
  return (
    <div className="flex flex-wrap items-center gap-4">
        <SkeletonWrapper isLoading={historyPeriods.isFetching} fullWidth={false}>
            ...
            >
                <TabsList>
                    <TabsTrigger value="year" className="data-[state=active]:bg-gray-300 data-[state=active]:text-black">Year</TabsTrigger>
                    <TabsTrigger value="month" className="data-[state=active]:bg-gray-300 data-[state=active]:text-black">Month</TabsTrigger>
                </TabsList>
            </Tabs>
        </SkeletonWrapper>
